...
class ShowContainersOnStorageElement {
  String? _token;
  ...
  Future<void> showContainersOnStorageElementMethod({
    required int storageElementId,
  }) async {
    var url = Uri.parse(
      'http://10.0.2.2:8000/api/show_continers_on_storage_element/$storageElementId',
    );
    ...
    try {
      ...
      if (response.statusCode == 202 || response.statusCode == 201) {
        ...
        print(
          'ShowContainersOnStorageElement sent successfully:${response.body}',
        );
      } else {
        print(
      ...
      print('An error occurred in ShowContainersOnStorageElement: $e');
    }
  }
}
